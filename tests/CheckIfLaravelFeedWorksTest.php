...
class CheckIfWeCanConvertAnArrayTest extends \PHPUnit\Framework\TestCase
{
    public function testIfWeGetAnArrayForOriginalFeed()
    {
    ...
    public function testIfWeGetAnArrayForNewFeed()
    {
        $feed = new \Tests\Transform\Profile();
        ...
        $this->assertArrayHasKey('NAME', $feed->getKeys());
    }
